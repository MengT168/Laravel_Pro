    ...
    <div class="container-fluid background-container">
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-cherry" id="card" >
                <a href="/user/list_car" style="text-decoration: none;" >
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-blue-dark" id="card" >
                <a href="/user/sold_car" style="text-decoration: none;" >
                <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><i class="fas fa-car"></i></div>
                    <div class="mb-4">
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-green-dark" id="card" >
               <a href="/user/list_model" style="text-decoration: none;"  >
               <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><i class="fas fa-car"></i></div>
                    <div class="mb-4">
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-orange-dark" id="card" >
                <a href="/user/list_income" style="text-decoration: none;" >
                <div class="card-statistic-3 p-4">
