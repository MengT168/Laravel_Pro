    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="project-info-box">
                ...
                <p><b>Model:</b> {{$value->modelName}}</p>
                <p><b>Year:</b> {{$value->year}}</p>
                <p><b>Status:</b> {{$value->status}}</p>
                <p><b>Condition:</b> {{$value->condition}}</p>
        ...
        <div class="col-md-7">
            <img src="/upload/{{$value->image}}" alt="project-image" class="rounded">
            <div class="project-info-box">
                <p><b>Vin:</b> {{$value->vin}}</p>
                <p><b>Mile:</b> {{$value->mile}}</p>
            </div><!-- / project-info-box -->
            <a href="/admin/list_car" class="btn btn-success" >Back</a>
            <a href="/admin/edit_car/{{$value->id}}" class="btn btn-primary" >Edit</a>
        </div><!-- / column -->
        @endforeach
    </div>
</div>
