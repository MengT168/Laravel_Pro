...
<div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/admin/list_car" method="get" style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                  ...
                  <a href="/admin/sold_car" class="btn btn-primary" >Check Sold Car</a>
                  <a href="/admin/list_car" class="btn btn-primary" >Refresh</a>
    ...
    <div class="col-md-4">
       ...
       <div class="card rounded">
            ...
            <div class="card-body text-center">
                ...
                <a class="ad-btn" href="/admin/detail/{{$value->id}}">View</a>
            </div>
        </div>
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/admin/delete_model/' + id;
            }
        })
    }
</script>
